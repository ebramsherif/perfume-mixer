...
export default function AIPairings({ perfume, onSelect }: AIPairingsProps) {
    ...
    return (
      <div className="bg-gradient-to-br from-purple-900/20 to-pink-900/20 border border-purple-500/30 rounded-2xl p-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-white">AI Finding Perfect Pairings...</h3>
            <p className="text-sm text-zinc-400">Analyzing note compatibility</p>
          </div>
        </div>
      </div>
    );
  ...
  if (error || pairings.length === 0) {
    return null; // Silently fail - regular recommendations will show
  }
    ...
    <div className="bg-gradient-to-br from-purple-900/20 to-pink-900/20 border border-purple-500/30 rounded-2xl overflow-hidden">
      <div className="p-5 border-b border-purple-500/20">
        ...
        <p className="text-sm text-zinc-400 mt-1">
          Fragrances that complement {perfume.name}
        </p>
      </div>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <svg className="w-4 h-4 text-purple-400 opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
